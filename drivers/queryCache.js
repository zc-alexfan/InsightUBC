...
var fs = require('fs');
var input = '{ "WHERE":{ "OR":[ { "IS":{ "courses_dept":"*th" } }, { "GT":{ "courses_avg": 89 } } ] }, "OPTIONS":{ "COLUMNS": ["courses_dept", "courses_id", "courses_instructor", "courses_avg"], "ORDER":"courses_avg", "FORM":"TABLE" } } ';
